...
router.post("/Registration", upload.single("teacherProfileImage"), async (req, res) => {
...
router.get("/Logout", TeacherLoggedInCheck, async (req, res) => {
...
router.get("/getAllTeachersData", async (req, res) => {
    try {
...
router.post("/createCourse", upload.single("courseImage"), TeacherLoggedInCheck, async (req, res) => {
...
router.post("/createLecture", lecturevideoUpload.single("lectureVideo"), async (req, res) => {
...
router.get("/getTeacherRelatedCourses", async (req, res) => {
...
router.post("/quizQuestionCreation", async (req, res) => {
    try {
...
router.post("/quizMarking", StudentLoggedInCheck, async (req, res) => {
